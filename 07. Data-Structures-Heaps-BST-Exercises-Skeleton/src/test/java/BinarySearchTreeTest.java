...
public class BinarySearchTreeTest {
    ...
    public void testRange() {
        ...
        //ако имаме 4х3, тестът ще върне true
        //3,5,6,7
    ...
    @Test
    public void testRant(){
        assertEquals(4, bst.rank(7));
    }
    @Test
    public void testRantMinElement() {
        assertEquals(0, bst.rank(-1));
    }
    @Test
    public void testRantEmptyTree() {
